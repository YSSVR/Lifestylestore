...
<!DOCTYPE html>
<!--
The product page is divided into three sections:
1. Header with navigation links to cart, settings, order history and log out.
2. Content
3. Footer.
"content consists of two parts.
1. The upper part has a heading “Welcome to our
Lifestyle Store!” and a text follows ,which is a jumbotron.
2 .The lower part has the grid system which displays the products: Camera,
Watches, and Shirts which has three rows. Each row has four columns and it
contains details of the product and a button.
Unless the user is logged in, he cannot go to the products page (With “Add to
cart” button). When he/she isn’t logged in and he tries to navigate to the above
page, he/she redirected to the products page (With “Buy now” button) of the
website. In this case, clicking on the logo from any page redirects the user to the
index/home page.
-->
<html>
    <head>
